...
import { Done as DoneIcon, Edit as EditICon, KeyboardBackspace as KeyboardBackspaceIcon } from '@mui/icons-material';
  ...
  >
    {
      ...
      <TextField/>
      <IconButton
      onClick={()=>updateGroupName}><DoneIcon/></IconButton>
      </> : 
      <>
